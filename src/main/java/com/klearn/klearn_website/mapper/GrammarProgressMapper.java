...
public interface GrammarProgressMapper {
  ...
  List<GrammarProgress> getGrammarProgressByUserIdAndCourseId(@Param("user_id") Integer userId, @Param("course_id") Integer courseId);
  ...
  void markGrammarTheoryAsLearned(@Param("user_id") Integer userId, @Param("grammar_id") Integer grammarId, @Param("course_id") Integer courseId);
  ...
  void markGrammarQuizAsFinished(@Param("user_id") Integer userId, @Param("grammar_id") Integer grammarId, @Param("course_id") Integer courseId);
  ...
  boolean existsByUserIdAndGrammarIdAndCourseId(@Param("user_id") Integer userId, @Param("grammar_id") Integer grammarId, @Param("course_id") Integer courseId);
  ...
  GrammarProgress getGrammarProgressByUserIdAndGrammarId(@Param("user_id") Integer userId, @Param("grammar_id") Integer grammarId);
}
