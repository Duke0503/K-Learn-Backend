...
public interface VocabularyProgressMapper {
    ...
    List<VocabularyProgress> getLearnedVocabularyProgressByUserIdAndTopicId(@Param("user_id") Integer userId,
            @Param("topic_id") Integer topicId);
    ...
    List<VocabularyProgress> getNotLearnedVocabularyProgressByUserIdAndTopicId(@Param("user_id") Integer userId,
            @Param("topic_id") Integer topicId);
}
