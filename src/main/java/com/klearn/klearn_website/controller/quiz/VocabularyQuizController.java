...
public class VocabularyQuizController {
  ...
  public ResponseEntity<List<VocabularyQuestion>> createVocabularyQuiz(@PathVariable Integer topicId) {
    Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
    String username = authentication.getName();

    User user = userService.getUser(username);  

    List<VocabularyQuestion> listQuestions = vocabularyQuizService.createVocabularyQuiz(user.getId(), topicId);
