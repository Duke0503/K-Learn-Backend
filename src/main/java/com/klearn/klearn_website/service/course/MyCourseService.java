  ...
  public String getGrammarProgressByUserIdAndCourseId(Integer userId, Integer courseId) {
    try {
        ...
        for (Grammar grammar : listGrammar) {
            GrammarProgress grammarProgress = grammarProgressMapper.getGrammarProgressByUserIdAndGrammarId(userId, grammar.getId());
            ...
            if (!listQuestion.isEmpty()) {
                ...
                for (QuestionGrammar questionGrammar : listQuestion) {
                    ...
                    if ("multichoice".equals(questionGrammar.getQuiz_type())) {
                        ...
                        String[] incorrectAnswers = questionGrammar.getIncorrect_answer().replaceAll("[\\[\\]\"]", "").split(",");
                    ...
                    question.put("options", "essay".equals(questionGrammar.getQuiz_type()) ? Collections.emptyList() : options);
